...
INSERT INTO lesson(lesson_id,professor_id, student_id, subject_id, price, lesson_status)
VALUES (1,1, 1, 1, 1200, 'PENDING_APPROVAL'),
       (2,1, 1, 1, 1200, 'IN_PROCESS'),
       (3,1, 1, 1, 1200, 'FINISHED'),
       (4,1, 1, 1, 1200, 'CANCELLED'),
       (5,2, 1, 2, 1200, 'PENDING_APPROVAL'),
       (6,2, 1, 2, 1200, 'IN_PROCESS'),
       (7,2, 1, 2, 1200, 'FINISHED'),
       (8,2, 1, 2, 1200, 'CANCELLED'),
       (9,3, 4, 6, 1200, 'PENDING_APPROVAL'),
       (10,3, 4, 6, 1200, 'IN_PROCESS'),
       (11,3, 4, 6, 1200, 'FINISHED'),
       (12,3, 4, 6, 1200, 'CANCELLED'),
       (13,3, 5, 2, 1200, 'PENDING_APPROVAL'),
       (14,3, 5, 2, 1200, 'IN_PROCESS'),
       (15,3, 5, 2, 1200, 'FINISHED'),
       (16,3, 5, 2, 1200, 'CANCELLED');

TRUNCATE TABLE review RESTART IDENTITY AND COMMIT NO CHECK;
INSERT INTO review(review_id,date,message, rating,user_id,lesson_id)
VALUES (1,'2021-11-07','Hola',4,1, 1),
       (7,'2021-11-07','Hola',4,2, 4),
       (14,'2021-11-07','Hola',4,3, 4),
       (18,'2021-11-07','Hola',4,5, 4);
